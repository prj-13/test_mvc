...
<h1>Редактировать задачу в приложение</h1>
...
<table border = "0" cellpadding = "2">
    <form name="login" method="post" action="./index.php/admin/updatedone">
    <tr>
      <td>visible = false:</td>
      <td><input type="text" size="10" name="id" disabled value="<?php echo $data["update"]["id_rec"];?>"></td>
    </tr>
    <tr>
      <td>Ваше имя:</td>
      <td><input type="text" size="10" name="name" disabled value="<?php echo $data["update"]["name_user"];?>"></td>
    </tr>
    <tr>
      <td>Электронная почта:</td>
      <td><input type="text" size="10" name="email" value="<?php echo $data["update"]["email_user"];?>"></td>
    </tr>
    <tr>
      <td colspan = "2"><textarea rows="10" name="text"><?php echo $data["update"]["task_user"];?></textarea></td>
    </tr>
    <tr>
      <td><input type="submit" value="Обновить" name="btn"	style="width: 150px; height: 30px;"></td>
    </tr>
    </form>
  </tr>
</table>
